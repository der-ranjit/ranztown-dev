import {
    ...
    Mesh,
    WebGLRenderer
    // typing alerts; stuff works though, so :shrug:
    // @ts-ignore
...
`
        ...
        document.getElementById('screenshot-basic-renderer')!.appendChild(renderer.domElement);
        document.getElementById('screenshot-basic-renderer')!.style.display = 'none';
